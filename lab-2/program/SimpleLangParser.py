...
def serializedATN():
    return [
        4,1,14,39,2,0,7,0,2,1,7,1,2,2,7,2,1,0,4,0,8,8,0,11,0,12,0,9,1,1,
        ...
        2,4,0,2,1,0,2,4,2,0,1,1,5,6,43,0,7,1,0,0,0,2,11,1,0,0,0,4,25,1,0,
        ...
        -1,0,15,16,5,1,0,0,16,26,3,4,2,8,17,26,5,9,0,0,18,26,5,10,0,0,19,
        26,5,11,0,0,20,26,5,12,0,0,21,22,5,7,0,0,22,23,3,4,2,0,23,24,5,8,
        0,0,24,26,1,0,0,0,25,14,1,0,0,0,25,17,1,0,0,0,25,18,1,0,0,0,25,19,
        1,0,0,0,25,20,1,0,0,0,25,21,1,0,0,0,26,35,1,0,0,0,27,28,10,7,0,0,
        28,29,7,0,0,0,29,34,3,4,2,8,30,31,10,6,0,0,31,32,7,1,0,0,32,34,3,
        4,2,7,33,27,1,0,0,0,33,30,1,0,0,0,34,37,1,0,0,0,35,33,1,0,0,0,35,
        36,1,0,0,0,36,5,1,0,0,0,37,35,1,0,0,0,4,9,25,33,35
    ]
...
class SimpleLangParser ( Parser ):
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & 7810) != 0)):
                    break
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [1]:
                localctx = SimpleLangParser.UnaryMinusContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
