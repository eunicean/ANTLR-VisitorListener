...
class SimpleLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleLangParser#UnaryMinus.
    def enterUnaryMinus(self, ctx:SimpleLangParser.UnaryMinusContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#UnaryMinus.
